...
**Quick check**: `npx vitest run tests/emit-gallery.test.ts --reporter=dot`

## Scope Boundaries

**Allowed to modify** (produces):
- `tests/emit-gallery.test.ts`
...
- [ ] Artifact exists: `tests/emit-gallery.test.ts`
- [ ] `npx vitest run tests/emit-gallery.test.ts --reporter=dot`
...
Verify with: `npx vitest run tests/emit-gallery.test.ts --reporter=dot`
